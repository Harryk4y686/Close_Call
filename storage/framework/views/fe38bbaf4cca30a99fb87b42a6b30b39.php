...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('events')); ?>" class="sidebar-icon active" data-page="events">
    ...
    <div class="main-content">
        ...
        <div class="events-content">
            ...
            <div class="events-card">
                ...
                <?php if(isset($myEvents) && $myEvents->count() > 0): ?>
                        ...
                        <?php $__currentLoopData = $myEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="event-card">
                                <div class="event-banner">
                                    <img src="<?php echo e($event->banner_url ?? asset('image/event1.png')); ?>" alt="<?php echo e($event->title); ?>" 
                                         style="width: 100%; height: 100%; object-fit: cover;"
                                         onerror="this.src='<?php echo e(asset('image/event1.png')); ?>';">
                                </div>
                                <div class="event-details">
                                    <p class="event-date"><?php echo e($event->formatted_date_time); ?></p>
                                    <h3 class="event-name"><?php echo e($event->title); ?></h3>
                                    <p class="event-location"><?php echo e($event->location ?? 'Location TBD'); ?> | <?php echo e($event->attendees_count ?? 0); ?> Attendees</p>
            ...
            <div class="recommended-section">
                ...
                <div class="events-scroll-container">
                    ...
                    <?php $__currentLoopData = $adminEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="event-card">
                        <div class="event-banner">
                            <img src="<?php echo e($event->banner_image ? asset('storage/' . $event->banner_image) : asset('image/default-event.png')); ?>" alt="<?php echo e($event->event_name); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <div class="event-details">
                            <p class="event-date"><?php echo e(\Carbon\Carbon::parse($event->starting_date)->format('D, d M Y')); ?></p>
                            <h3 class="event-name"><?php echo e($event->event_name); ?></h3>
                            <p class="event-location"><?php echo e($event->location); ?> | <?php echo e($event->attendees); ?> Attendees</p>
                            <div class="event-actions">
                                <a href="<?php echo e(route('admin.events.view', $event->id)); ?>">
    ...
    </div><?php /**PATH C:\laragon\www\Close_Call\resources\views/events.blade.php ENDPATH**/ ?>