...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('AI')); ?>" class="sidebar-icon" data-page="AI">
            <img src="<?php echo e(asset('image/chats.png')); ?>" alt="Chats" class="sidebar-icon-img">
        </a>
    </div>
                ...
                <div class="categories-container">
                    ...
                    <a href="#" class="category-card" data-category="graphics-design">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/graphicdesign.png')); ?>" alt="Graphics & Design">
                        </div>
                    ...
                    <a href="#" class="category-card" data-category="music-audio">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/musicaudio.png')); ?>" alt="Music & Audio">
                        </div>
                        <div class="category-info">
                    ...
                    <a href="#" class="category-card" data-category="account-finance">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/accountfinance.png')); ?>" alt="Account & Finance">
                        </div>
                        <div class="category-info">
                    ...
                    <a href="#" class="category-card" data-category="code-programming">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/codeprogramming.png')); ?>" alt="Code & Programming">
                        </div>
                        <div class="category-info">
                    ...
                    <a href="#" class="category-card" data-category="digital-marketing">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/digitalmarketing.png')); ?>" alt="Digital Marketing">
                        </div>
                        <div class="category-info">
                    ...
                    <a href="#" class="category-card" data-category="health-care">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/healthcare.png')); ?>" alt="Health & Care">
                        </div>
                        <div class="category-info">
                    ...
                    <a href="#" class="category-card" data-category="video-animation">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/videoanimation.png')); ?>" alt="Video & Animation">
                        </div>
                        <div class="category-info">
                    ...
                    <a href="#" class="category-card" data-category="data-science">
                        <div class="category-icon">
                            <img src="<?php echo e(asset('image/datascience.png')); ?>" alt="Data & Science">
                        </div>
                        <div class="category-info">
...
<?php /**PATH C:\laragon\www\Close_Call\resources\views/JobsCategories.blade.php ENDPATH**/ ?>