...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('profile')); ?>" class="sidebar-icon" data-page="home">
        ...
        <a href="<?php echo e(route('AI')); ?>" class="sidebar-icon" data-page="AI">
            <img src="<?php echo e(asset('image/genius.png')); ?>" alt="AI" class="sidebar-icon-img">
        </a>
    </div>
    ...
    <div class="job-logo-container">
        <div class="job-logo-circle">
            <?php if($job->profile_picture): ?>
                <img src="<?php echo e(asset('storage/' . $job->profile_picture)); ?>" alt="<?php echo e($job->company_name); ?>">
            <?php else: ?>
                <img src="<?php echo e(asset('image/socialmediamanager.png')); ?>" alt="<?php echo e($job->company_name); ?>">
            <?php endif; ?>
        </div>
    </div>
    <div class="job-details-container">
        <div class="job-posting-title"><?php echo e($job->job_title); ?></div>
        <div class="job-posting-meta"><?php echo e($job->location); ?> | <?php echo e($job->company_name); ?></div>
...
</html><?php /**PATH C:\laragon\www\Close_Call\resources\views/JobsOpened.blade.php ENDPATH**/ ?>