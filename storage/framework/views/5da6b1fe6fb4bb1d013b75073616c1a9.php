    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-6 flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-black">User Database</h1>
                    <p class="text-gray-500 mt-1">Manage your users.</p>
                </div>
                <a href="<?php echo e(route('adminuseradd')); ?>" class="bg-[#00A88F] hover:bg-[#008f7a] text-white px-6 py-2.5 rounded-full font-medium transition-colors inline-block">
                    Add Users
                </a>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="mb-4">
                    <button class="hover:opacity-90 transition-opacity">
                        <img src="<?php echo e(asset('image/logo.png')); ?>" alt="Logo" class="w-[43px] h-[43px]">
                    </button>
                </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-gray-100">
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">First Name</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Last Name</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Phone Number</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Date of Birth</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Location</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Postal Code</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Resume</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">CV</th>
                            <th class="p-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Portfolio</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="p-4 text-sm font-medium text-gray-900"><?php echo e($user->first_name); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e($user->last_name); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e($user->email); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e($user->phone_number ?? 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e(optional($user->registeredProfile)->date_of_birth ?? 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e(optional($user->registeredProfile)->location ?? 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e(optional($user->registeredProfile)->postal_code ?? 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e(optional($user->registeredProfile)->resume_path ? 'Yes' : 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e(optional($user->registeredProfile)->cv_path ? 'Yes' : 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e(optional($user->registeredProfile)->portfolio_path ? 'Yes' : 'N/A'); ?></td>
                            <td class="p-4 text-sm text-gray-600"><?php echo e($user->created_at->format('d/m/Y')); ?></td>
                            <td class="p-4 text-center">
                                <a href="<?php echo e(route('adminuseredit', $user->id)); ?>" class="w-8 h-8 rounded-full bg-teal-50 text-[#00A88F] flex items-center justify-center hover:bg-teal-100 transition-colors">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                </a>
                            </td>
                            <td class="p-4 text-center">
                                <form action="<?php echo e(route('adminuserdelete', $user->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" onclick="return confirm('Are you sure you want to delete this user?')" class="w-8 h-8 rounded-full bg-red-50 text-red-500 flex items-center justify-center hover:bg-red-100 transition-colors">
                        ...
                        <tr>
                            <td colspan="13" class="p-8 text-center text-gray-500">
                                No users found. <a href="<?php echo e(route('adminuseradd')); ?>" class="text-[#00A88F] hover:underline">Add your first user!</a>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
<?php /**PATH C:\laragon\www\Close_Call\resources\views/admin/AdminUserDatabase.blade.php ENDPATH**/ ?>