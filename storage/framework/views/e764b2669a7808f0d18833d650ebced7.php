...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('chats')); ?>" class="sidebar-icon active" data-page="chats">
    ...
    <script>
        (function() {
            ...
            const authId = <?php echo json_encode(\Illuminate\Support\Facades\Auth::guard('pengguna')->check() ? \Illuminate\Support\Facades\Auth::guard('pengguna')->id() : \Illuminate\Support\Facades\Auth::guard('web')->id(), 15, 512) ?>;
            ...
            formEl.addEventListener('submit', function(e){
                ...
                fetch(`<?php echo e(route('chats.store')); ?>`, {
                    method: 'POST',
            ...
            function fetchUsersList(){
                fetch(`<?php echo e(route('users.list')); ?>`, { headers: { 'X-Requested-With': 'XMLHttpRequest' }})
    ...
    </html><?php /**PATH C:\laragon\www\Close_Call\resources\views/chat/index-chat.blade.php ENDPATH**/ ?>