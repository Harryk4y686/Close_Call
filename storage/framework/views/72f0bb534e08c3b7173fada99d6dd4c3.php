...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('jobs')); ?>" class="sidebar-icon" data-page="jobs">
        ...
        <a href="<?php echo e(route('chats')); ?>" class="sidebar-icon" data-page="chats">
    ...
    <div class="content-container">
        <div class="content-layout">
            ...
            <div class="profile-card">
                ...
                <div class="profile-card-body">
                    ...
                    <div class="avatar-row">
                        <div class="avatar">
                            <?php if(isset($profile) && $profile->profile_picture): ?>
                                <img src="<?php echo e(asset('storage/' . $profile->profile_picture)); ?>" alt="Profile Picture" onerror="this.src='<?php echo e(asset('image/anthony.png')); ?>'">
                            <?php else: ?>
                                <img src="<?php echo e(asset('image/anthony.png')); ?>" alt="Profile Picture">
                            <?php endif; ?>
                        </div>
                        <div class="profile-info">
                            <div class="profile-name"><?php echo e($user->first_name ?? 'User'); ?> <?php echo e($user->last_name ?? ''); ?></div>
                            <div class="profile-location"><?php echo e($profile->location ?? $user->country ?? 'Not specified'); ?></div>
                            <a href="<?php echo e(route('edit.profile')); ?>" class="edit-profile-btn">Edit Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($user->email ?? 'Not provided'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Phone Number</div>
                        <div class="info-value"><?php echo e($user->phone_number ?? 'Not provided'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Gender</div>
                        <div class="info-value"><?php echo e(isset($profile->gender) ? ucfirst($profile->gender) : 'Not specified'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Address</div>
                        <div class="info-value"><?php echo e($profile->location ?? 'Not provided'); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="jobs-section">
                ...
                <div class="job-card">
                    <div class="job-logo">
                        <img src="<?php echo e(asset('image/halojasa.png')); ?>" alt="Company" />
                    </div>
                    <div class="job-info">
                ...
                <div class="job-card">
                    <div class="job-logo">
                        <img src="<?php echo e(asset('image/JCI.png')); ?>" alt="Company" />
                    </div>
                    <div class="job-info">
            ...
            <div class="right-sidebar">
                ...
                <div class="completion-section">
                    ...
                    <div class="progress-circle" style="background: conic-gradient(#00A88F 0deg <?php echo e(($profile->completion_percentage ?? 0) * 3.6); ?>deg, #e5e7eb <?php echo e(($profile->completion_percentage ?? 0) * 3.6); ?>deg 360deg);">
                        <span class="progress-text"><?php echo e($profile->completion_percentage ?? 0); ?>%</span>
                    </div>
                    <ul class="completion-list">
                        ...
                        <li class="completion-item">
                            <div class="completion-status">
                                <?php if(isset($user->first_name) && isset($user->last_name) && isset($user->email) && isset($user->phone_number) && isset($profile->date_of_birth) && isset($profile->gender)): ?>
                                    <span class="check-icon">✓</span>
                                <?php else: ?>
                                    <span class="x-icon">X</span>
                                <?php endif; ?>
                        ...
                        <li class="completion-item">
                            <div class="completion-status">
                                <?php if(isset($profile->location) && isset($profile->postal_code)): ?>
                                    <span class="check-icon">✓</span>
                                <?php else: ?>
                                    <span class="x-icon">X</span>
                                <?php endif; ?>
                        ...
                        <li class="completion-item">
                            <div class="completion-status">
                                <?php if(isset($profile->resume_path) && isset($profile->cv_path)): ?>
                                    <span class="check-icon">✓</span>
                                <?php else: ?>
                                    <span class="x-icon">X</span>
                                <?php endif; ?>
                        ...
                        <li class="completion-item">
                            <div class="completion-status">
                                <?php if(isset($profile->portfolio_path) && $profile->portfolio_path): ?>
                                    <span class="check-icon">✓</span>
                                <?php else: ?>
                                    <span class="x-icon">X</span>
                                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\Close_Call\resources\views/profile.blade.php ENDPATH**/ ?>