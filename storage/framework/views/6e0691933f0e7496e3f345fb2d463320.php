...
<head>
    ...
    <style>
        * {
        ...
        /* Header Navigation */
        .header {
            background: url('/image/landingpage.mp4');
...
<body class="bg-white text-black leading-6 font-poppins">
    ...
    <div class="header">
        <div class="container w-full max-w-6xl mx-auto px-5">
            <nav class="navigation flex justify-end items-center mb-20 scroll-animate scroll-animate-up">
                ...
                <a href="<?php echo e(route('profile')); ?>" class="nav-link profile-link">
                    <?php if(isset($profile) && $profile->profile_picture): ?>
                        <img src="<?php echo e(asset('storage/' . $profile->profile_picture)); ?>" alt="Profile" class="profile-icon" style="object-fit: cover;">
                    <?php else: ?>
                        <img src="<?php echo e(asset('image/profileicon.png')); ?>" alt="Profile" class="profile-icon">
                    <?php endif; ?>
            ...
            <div class="hero-section text-center scroll-animate scroll-animate-left">
                ...
                <div class="stats-container flex justify-center flex-wrap">
                    <div class="stat-card bg-white px-5 py-2 flex flex-row items-center scroll-animate scroll-animate-scale delay-100">
                        <img src="<?php echo e(asset('image/livejobs.png')); ?>" alt="Live Jobs" class="stat-icon">
                    ...
                    <div class="stat-card bg-white px-5 py-2 flex flex-row items-center scroll-animate scroll-animate-scale delay-200">
                        <img src="<?php echo e(asset('image/companies.png')); ?>" alt="Companies" class="stat-icon">
                        <div class="stat-content">
                    ...
                    <div class="stat-card bg-white px-5 py-2 flex flex-row items-center scroll-animate scroll-animate-scale delay-300">
                        <img src="<?php echo e(asset('image/candidates.png')); ?>" alt="Candidates" class="stat-icon">
                        <div class="stat-content">
                    ...
                    <div class="stat-card bg-white px-5 py-2 flex flex-row items-center scroll-animate scroll-animate-scale delay-400">
                        <img src="<?php echo e(asset('image/newjobs.png')); ?>" alt="New Jobs" class="stat-icon">
                        <div class="stat-content">
        ...
        <div class="container w-full max-w-6xl mx-auto px-5">
            ...
            <div class="categories-grid grid grid-cols-4 gap-5">
                ...
                <div class="category-card scroll-animate scroll-animate-right delay-200">
                    <img src="<?php echo e(asset('image/musicaudio.png')); ?>" alt="Code & Programming" class="category-icon">
                    <div class="category-content">
        ...
        <div class="container w-full max-w-6xl mx-auto px-5">
            ...
            <div class="jobs-list">
                <div class="job-card scroll-animate scroll-animate-right delay-100">
                    <img src="<?php echo e(asset('image/dataanalyst.png')); ?>">
                    <div class="job-details">
                        <div class="job-title">Data Analyst</div>
                        <div class="job-company">Indonesia | GRHA Digital</div>
                        <div class="job-status">
                            <img src="<?php echo e(asset('image/eye.png')); ?>" alt="Viewing" width="16" height="10">
                ...
                <div class="job-card scroll-animate scroll-animate-left delay-200">
                    <img src="<?php echo e(asset('image/socialmediamanager.png')); ?>" alt="Best Partner Education" class="job-logo">
                    <div class="job-details">
                ...
                <div class="job-card scroll-animate scroll-animate-right delay-300">
                    <img src="<?php echo e(asset('image/mechanicalengineer.png')); ?>" alt="R-Tech Computer" class="job-logo">
                    <div class="job-details">
                ...
                <div class="job-card scroll-animate scroll-animate-left delay-400">
                    <img src="<?php echo e(asset('image/marketingteam.png')); ?>" alt="DNA Indonesia" class="job-logo">
                    <div class="job-details">
                ...
                <div class="job-card scroll-animate scroll-animate-right delay-500">
                    <img src="<?php echo e(asset('image/accountant.png')); ?>" alt="SOECHI GROUP" class="job-logo">
                    <div class="job-details">
    ...
    <!-- Reviews Section -->
    <section class="section bg-[#E6ECF1] scroll-animate scroll-animate-right">
        <div class="container w-full max-w-6xl mx-auto px-5">
            ...
            <div class="reviews-container">
                <div class="review-card scroll-animate scroll-animate-scale delay-100">
                    ...
                    <img src="<?php echo e(asset('image/sammy.png')); ?>" alt="Sammy Louise" class="reviewer-avatar">
                ...
                <div class="review-card scroll-animate scroll-animate-scale delay-200">
                    ...
                    <img src="<?php echo e(asset('image/jennifer.png')); ?>" alt="Jennifer Lim" class="reviewer-avatar">
                    <div class="review-spacer"></div>
                ...
                <div class="review-card scroll-animate scroll-animate-scale delay-300">
                    ...
                    <img src="<?php echo e(asset('image/anthony.png')); ?>" alt="Anthony Brown" class="reviewer-avatar">
                    <div class="review-spacer"></div>
                ...
                <div class="review-card scroll-animate scroll-animate-scale delay-400">
                    ...
                    <img src="<?php echo e(asset('image/timothy.png')); ?>" alt="Timothy Wang" class="reviewer-avatar">
                    <div class="review-spacer"></div>
                ...
                <div class="review-card scroll-animate scroll-animate-scale delay-500">
                    ...
                    <img src="<?php echo e(asset('image/meiling.png')); ?>" alt="Meiling" class="reviewer-avatar">
                    <div class="review-spacer"></div>
    ...
    <section class="section bg-white scroll-animate scroll-animate-left">
        <div class="container w-full max-w-6xl mx-auto px-5">
            <div class="ai-section text-center">
                <img src="<?php echo e(asset('image/AI.png')); ?>" alt="CloseCall AI" class="ai-logo scroll-animate scroll-animate-scale delay-100">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <img src="<?php echo e(asset('image/logo.png')); ?>" alt="CloseCall Logo" class="footer-logo">
                </div>
...
</html><?php /**PATH C:\laragon\www\Close_Call\resources\views/landing-page.blade.php ENDPATH**/ ?>