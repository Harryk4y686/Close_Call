...
<body>
    <!-- Left Sidebar -->
    <div class="sidebar">
        <a href="<?php echo e(route('landing-page')); ?>" class="sidebar-logo">
            <img src="<?php echo e(asset('image/logo.png')); ?>" alt="CloseCall Logo" class="logo-img">
        </a>
        <a href="<?php echo e(route('landing-page')); ?>" class="sidebar-icon" data-page="home">
            <img src="<?php echo e(asset('image/home.png')); ?>" alt="Home" class="sidebar-icon-img">
        </a>
        <a href="<?php echo e(route('jobs')); ?>" class="sidebar-icon active" data-page="jobs">
            <img src="<?php echo e(asset('image/jobs.png')); ?>" alt="Jobs" class="sidebar-icon-img">
        </a>
        <a href="<?php echo e(route('events')); ?>" class="sidebar-icon" data-page="events">
            <img src="<?php echo e(asset('image/events.png')); ?>" alt="Events" class="sidebar-icon-img">
        </a>
        <a href="<?php echo e(route('chats')); ?>" class="sidebar-icon" data-page="AI">
            <img src="<?php echo e(asset('image/chats.png')); ?>" alt="Chats" class="sidebar-icon-img">
        </a>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <a href="<?php echo e(route('profile')); ?>" class="avatar-icon">
                <?php if(isset($profile) && $profile->profile_picture): ?>
                    <img src="<?php echo e(asset('storage/' . $profile->profile_picture)); ?>" alt="Profile" 
        ...
        <div class="content-wrapper">
            ...
            <div class="jobs-header">
                <img src="<?php echo e(asset('image/logo.png')); ?>" alt="CloseCall">
            ...
            <div class="categories-grid grid grid-cols-4 gap-5">
                <div class="category-card">
                    <img src="<?php echo e(asset('image/graphicdesign.png')); ?>" alt="Graphics & Design" class="category-icon">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/codeprogramming.png')); ?>" alt="Code & Programming" class="category-icon">
                    <div class="category-content">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/digitalmarketing.png')); ?>" alt="Digital Marketing" class="category-icon">
                    <div class="category-content">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/videoanimation.png')); ?>" alt="Video & Animation" class="category-icon">
                    <div class="category-content">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/musicaudio.png')); ?>" alt="Music & Audio" class="category-icon">
                    <div class="category-content">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/accountfinance.png')); ?>" alt="Account & Finance" class="category-icon">
                    <div class="category-content">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/healthcare.png')); ?>" alt="Health & Care" class="category-icon">
                    <div class="category-content">
                ...
                <div class="category-card">
                    <img src="<?php echo e(asset('image/datascience.png')); ?>" alt="Data & Science" class="category-icon">
                    <div class="category-content">
            ...
            <a href="<?php echo e(route('jobs.categories')); ?>" class="see-all-link">See all...</a>
            ...
            <div class="jobs-list">
                ...
                <div class="job-card" style="cursor: pointer;" title="Click to apply for this position">
                    <img src="<?php echo e(asset('image/socialmediamanager.png')); ?>" alt="Social Media Manager" class="job-logo">
                ...
                <?php $__currentLoopData = $openJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="job-card" data-job-id="<?php echo e($job->id); ?>">
                    <img src="<?php echo e($job->profile_picture ? asset('storage/' . $job->profile_picture) : asset('image/default-job.png')); ?>" alt="<?php echo e($job->job_name); ?>" class="job-logo">
                    <div class="job-details">
                        <div class="job-title"><?php echo e($job->job_name); ?></div>
                        <div class="job-company"><?php echo e($job->location); ?> | <?php echo e($job->company); ?></div>
                        <div class="job-status">
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/>
                            </svg>
                    ...
                    <a href="#" class="job-apply-btn delete-job-btn" data-job-id="<?php echo e($job->id); ?>">×</a>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <a href="<?php echo e(route('jobs.opened')); ?>" class="see-all-link">See all</a>
                ...
                <div class="detailed-jobs-section" id="jobsContainer">
                    ...
                    <div class="djob-card">
                        <div class="djob-header">
                            <img style="width: 65px; height:65px" src="<?php echo e(asset('image/socialmediamanager.png')); ?>" class="djob-logo" alt="Logo">
                    ...
                    <!-- Dynamic Admin Jobs -->
                    <?php $__currentLoopData = $detailedJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="djob-card" data-job-id="<?php echo e($job->id); ?>">
                        <div class="djob-header">
                            <img style="width: 65px; height:65px" src="<?php echo e($job->profile_picture ? asset('storage/' . $job->profile_picture) : asset('image/default-job.png')); ?>" class="djob-logo" alt="Logo">
                            <div class="djob-headcol">
                                <div class="djob-title-row">
                                    <div class="djob-title"><?php echo e($job->job_name); ?></div>
                                    <div class="djob-actions">
                                        <a href="#" class="djob-apply">+ Apply</a>
                                        <a href="#" class="djob-more" aria-label="More options">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="#111827"><circle cx="12" cy="9" r="2"/><circle cx="12" cy="15" r="2"/></svg>
                                ...
                                <div class="djob-subinfo"><?php echo e($job->location); ?> | <?php echo e($job->company); ?></div>
                                <div class="djob-meta">
                                    <span class="djob-meta-item djob-meta-item--green">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>
                                        Actively reviewing applications
                        ...
                        <div class="djob-section-title">Job Description</div>
                        <div class="djob-desc"><?php echo nl2br(e($job->description)); ?></div>
                        
                        <?php if($job->tag_1 || $job->tag_2 || $job->tag_3 || $job->tag_4): ?>
                        <div class="djob-tags">
                            <?php if($job->tag_1): ?><span class="dtag"><?php echo e($job->tag_1); ?></span><?php endif; ?>
                            <?php if($job->tag_2): ?><span class="dtag"><?php echo e($job->tag_2); ?></span><?php endif; ?>
                            <?php if($job->tag_3): ?><span class="dtag"><?php echo e($job->tag_3); ?></span><?php endif; ?>
                            <?php if($job->tag_4): ?><span class="dtag"><?php echo e($job->tag_4); ?></span><?php endif; ?>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        function updateJobsProgress() {
            fetch('<?php echo e(route("profile.completion")); ?>')
...
```<?php /**PATH C:\laragon\www\Close_Call\resources\views/jobs.blade.php ENDPATH**/ ?>