...
<body class="bg-white text-black leading-6 font-poppins">
    ...
    <div class="header">
        <video class="header-video" autoplay muted loop playsinline>
            <source src="<?php echo e(asset('image/landingpage.mp4')); ?>" type="video/mp4">
        ...
        <div class="container w-full max-w-6xl mx-auto px-5">
            ...
            <div class="jobs-list">
                <div class="job-card scroll-animate scroll-animate-right delay-100">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="job-apply-btn">+</a>
                </div>
...
</html><?php /**PATH C:\laragon\www\Close_Call\resources\views/landingPage.blade.php ENDPATH**/ ?>