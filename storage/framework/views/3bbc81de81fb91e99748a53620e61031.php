...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('landing-page')); ?>" class="sidebar-icon active" data-page="home">
            ...
            <div class="job-company-info animate-scaleIn">
                <div class="company-header">
                    <div class="company-left">
                        <img src="<?php echo e(asset('image/socialmediamanager.png')); ?>" alt="Best Partner Education" class="company-logo animate-float">
                    ...
                    <div class="section-content">
                        <div class="location-content">
                            <div class="map-container">
                                <img src="<?php echo e(asset('image/pontianak.jpg')); ?>" alt="Map of Pontianak, Kalimantan Barat" class="map-image">
                            </div>
                            <div class="location-details">
                                ...
                                <a href="https://www.google.com/maps/place/Jl.+Prof.+DR.+Hamka+No.29,+Sungai+Jawi,+Kec.+Pontianak+Kota,+Kota+Pontianak,+Kalimantan+Barat+78115/@-0.0237033,109.3205903,17z/data=!3m1!4b1!4m6!3m5!1s0x2e1d58f1183a4941:0xbadf541c7933f3d0!8m2!3d-0.0237033!4d109.3231706!16s%2Fg%2F11vqmy4hl8?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D" class="get-directions">
                                    Get directions
                                    <img src="<?php echo e(asset('image/getdirection.png')); ?>" alt="External link icon" style="margin-left: 10px">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="djob-headcol">
                                <div class="djob-title-row">
                                    ...
                                    <div class="djob-actions">
                                        <a href="<?php echo e(route('bestpartnerjob')); ?>" class="djob-apply">+ Apply</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                window.location.href = '<?php echo e(route("bestpartnerjob")); ?>';
            });
        });
...
<?php /**PATH C:\laragon\www\Close_Call\resources\views/aboutBestPartner.blade.php ENDPATH**/ ?>