    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="main-section">
                <form action="<?php echo e(route('adminuseradd.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Close_Call\resources\views/admin/adminUser.blade.php ENDPATH**/ ?>