...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('AdminDashboard') }}" class="sidebar-icon active" data-page="home">
    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="mb-6 bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <p class="text-gray-600 mb-6">{{ date('l, d F Y') }}</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="text-3xl font-bold text-black mb-1">{{ $stats['users'] }}</div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="text-3xl font-bold text-black mb-1">{{ $stats['jobs'] }}</div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="text-3xl font-bold text-black mb-1">{{ $stats['events'] }}</div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="text-3xl font-bold text-black mb-1">{{ $stats['companies'] }}</div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Manage Users -->
                    <a href="{{ route('AdminUserDatabase') }}" class="bg-[#e9f0f5] hover:bg-[#dde5eb] p-8 rounded-2xl flex flex-col items-center justify-center transition-colors group text-decoration-none">
                    ...
                    <!-- Manage Jobs -->
                    <a href="{{ route('AdminJobDatabase') }}" class="bg-[#e9f0f5] hover:bg-[#dde5eb] p-8 rounded-2xl flex flex-col items-center justify-center transition-colors group text-decoration-none">
                        <div class="mb-4 text-gray-500 group-hover:text-gray-700">
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect>
                                <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>
                    ...
                    <!-- Manage Events -->
                    <a href="{{ route('AdminEventDatabase') }}" class="bg-[#e9f0f5] hover:bg-[#dde5eb] p-8 rounded-2xl flex flex-col items-center justify-center transition-colors group text-decoration-none">
                        <div class="mb-4 text-gray-500 group-hover:text-gray-700">
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                <line x1="16" y1="2" x2="16" y2="6"></line>
                    ...
                    <!-- Manage Companies -->
                    <a href="{{ route('AdminCompanyDatabase') }}" class="bg-[#e9f0f5] hover:bg-[#dde5eb] p-8 rounded-2xl flex flex-col items-center justify-center transition-colors group text-decoration-none">
                        <div class="mb-4 text-gray-500 group-hover:text-gray-700">
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M3 21h18"></path>
                                <path d="M5 21V7l8-4 8 4v14"></path>
