    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="main-section">
                <!-- Profile Header -->
                <div class="profile-header" style="background-image: url('{{ $job->banner_image ? asset('storage/' . $job->banner_image) : asset('image/defaultbanner.png') }}');">
                    ...
                    <div class="profile-avatar">
                        @if($job->profile_picture)
                            <img src="{{ asset('storage/' . $job->profile_picture) }}" alt="Profile Picture">
                        @else
                ...
                <form action="{{ route('adminjobedit.update', $job->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                ...
                <div class="add-job-card">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="job_name" value="{{ $job->job_name }}" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" name="tags" value="@if($job->tag_1)#{{ $job->tag_1 }}@endif @if($job->tag_2)#{{ $job->tag_2 }}@endif @if($job->tag_3)#{{ $job->tag_3 }}@endif @if($job->tag_4)#{{ $job->tag_4 }}@endif" placeholder="#tag1 #tag2">
                    </div>
                    </div>
                </div>
