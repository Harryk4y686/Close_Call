        ...
        <div class="content-wrapper">
            ...
            <div class="jobs-opened-section">
                ...
                <div class="job-posting-card">
                    <div class="job-logo-container">
                        <div class="job-logo-circle">
                            <img src="{{ asset('image/dataanalyst.png') }}" alt="GRHA Digital">
                        </div>
                    </div>
                    <div class="job-details-container">
                        <div class="job-posting-title">Data Analyst</div>
                        <div class="job-posting-meta">Indonesia | GRHA Digital</div>
                ...
                <div class="job-posting-card">
                    <div class="job-logo-container">
                        <div class="job-logo-circle">
                            <img src="{{ asset('image/socialmediamanager.png') }}" alt="Best Partner Education">
                        </div>
                    </div>
                    <div class="job-details-container">
                        <div class="job-posting-title">Social Media Manager</div>
                        <div class="job-posting-meta">Indonesia | Best Partner Education</div>
                        <div class="job-posting-status">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 5c-7 0-10 7-10 7s3 7 10 7 10-7 10-7-3-7-10-7Zm0 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" fill="#00A88F"/>
                            </svg>
                ...
                <!-- Job 3: Mechanical Engineer -->
                <div class="job-posting-card">
                    <div class="job-logo-container">
                        <div class="job-logo-circle">
                            <img src="{{ asset('image/mechanicalengineer.png') }}" alt="R-Tech Computer">
                        </div>
                    </div>
                    <div class="job-details-container">
                        <div class="job-posting-title">Mechanical Engineer</div>
                        <div class="job-posting-meta">Indonesia | R-Tech Computer</div>
                        <div class="job-posting-status">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 5c-7 0-10 7-10 7s3 7 10 7 10-7 10-7-3-7-10-7Zm0 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" fill="#00A88F"/>
                            </svg>
                ...
                <!-- Job 4: Marketing Team -->
                <div class="job-posting-card">
                    <div class="job-logo-container">
                        <div class="job-logo-circle">
                            <img src="{{ asset('image/marketingteam.png') }}" alt="DNA Indonesia">
                        </div>
                    </div>
                    <div class="job-details-container">
                        <div class="job-posting-title">Marketing Team</div>
                        <div class="job-posting-meta">Indonesia | DNA Indonesia</div>
                        <div class="job-posting-status">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 5c-7 0-10 7-10 7s3 7 10 7 10-7 10-7-3-7-10-7Zm0 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" fill="#00A88F"/>
                            </svg>
                ...
                <div class="job-posting-card">
                    <div class="job-logo-container">
                        <div class="job-logo-circle">
                            <img src="{{ asset('image/accountant.png') }}" alt="SOECHI GROUP">
                        </div>
                    </div>
                    <div class="job-details-container">
                        <div class="job-posting-title">Accountant</div>
                        <div class="job-posting-meta">Indonesia | SOECHI GROUP</div>
                        <div class="job-posting-status">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 5c-7 0-10 7-10 7s3 7 10 7 10-7 10-7-3-7-10-7Zm0 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" fill="#00A88F"/>
                            </svg>
